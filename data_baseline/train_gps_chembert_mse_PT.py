"""
train_gps_chembert_mse.py - GPS + ChemicalBERT + MSE Loss (Compatible .pt et .csv)
"""
...
class MolGNN(nn.Module):
    ...
    def forward(self, batch: Batch):
        ...
        g = self.proj(g)
        # IMPORTANT: Normalisation ajoutée comme discuté précédemment
...
def train_epoch(model, loader, optimizer, device):
    ...
    for graphs, text_emb in pbar:
        ...
        # IMPORTANT: Normalisation du texte cible aussi
...
def eval_retrieval(model, data_path, emb_dict, device):
    ...
    for graphs, text_emb in dl:
        ...
        # IMPORTANT: Normalisation pour l'évaluation
...
def main():
    ...
    if args.train_emb is None:
        args.train_emb = str(data_dir / "train_embeddings.csv")
    if args.val_emb is None:
        args.val_emb = str(data_dir / "validation_embeddings.csv")
    
    # --- MODIFICATION ICI : On utilise smart_load_embeddings ---
